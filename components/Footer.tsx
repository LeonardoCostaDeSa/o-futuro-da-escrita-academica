        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-16 mb-20">
          ...
          <div className="md:col-span-7 grid grid-cols-2 md:grid-cols-3 gap-12">
            <div className="text-center md:text-left">
              <p className="text-white font-black text-[10px] uppercase tracking-[0.3em] mb-8 opacity-40">Navegação</p>
            ...
            <div className="text-center md:text-left">
              <p className="text-white font-black text-[10px] uppercase tracking-[0.3em] mb-8 opacity-40">Suporte</p>
              <ul className="space-y-4 text-xs text-master-light/50 font-bold uppercase tracking-widest">
            ...
            <div className="col-span-2 md:col-span-1 text-center md:text-left">
              <p className="text-white font-black text-[10px] uppercase tracking-[0.3em] mb-8 opacity-40">Presença Digital</p>
