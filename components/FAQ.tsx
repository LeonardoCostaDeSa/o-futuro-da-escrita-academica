...
import { PRICE_FULL, PRICE_INSTALLMENTS, PRICE_INSTALLMENT_VALUE } from '../config';
...
const faqs = [
  ...
  {
    q: `R$${PRICE_FULL} é muito para o meu momento atual.`,
  ...
  },
  {
    ...
    a: `O curso pode ser adquirido via cartão de crédito ou Pix. No cartão, o pagamento pode ser parcelado em até ${PRICE_INSTALLMENTS}x de R$${PRICE_INSTALLMENT_VALUE} — são aceitas todas as principais bandeiras, incluindo Visa, Mastercard, Elo e Hipercard. No Pix, o valor é R$${PRICE_FULL} à vista. Em ambos os casos, o acesso é liberado automaticamente assim que o pagamento é confirmado, sem nenhuma etapa adicional da sua parte.`,
  },
  {
